...
async def diarize_endpoint(video_id: str):
    ...
    4. Merge speaker labels into the transcription JSON
    """
    ...
    # Step 4: Cache the result as JSON on disk
    result = {"speakers": speakers, "segments": diar_segments}
    diar_path.write_text(json.dumps(result))

    # Step 5: Merge speaker labels into the transcription JSON (Task 3)
